...
st.caption("Quantitative intelligence platform — Phase 1 Core | Future Grok daily feed")
...
st.info(f"Global Macro Regime (conceptual): **{macro_sum.get('regime')}** | Indicators: {macro_sum.get('n_indicators', 0)}")
...
""")
st.sidebar.markdown("---")
st.sidebar.caption("Phase 1 — Core platform\nGrok daily automation → Phase 2")
